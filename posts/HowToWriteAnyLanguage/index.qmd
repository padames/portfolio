...
![Figure 2. The table for the food-fruit emoji category taken from the Unicode standard chart @uni16:emojicharts](Food-fruit-unicode-emoji-chart.png)
...
Remember the rules for representing UTF-8 encoded bytes from startand end Unicode points (or values), well if you have a look at the last four bytes of the sentence above: `11110000 10011111 10001101 10001000` removing the initial 0 that indicates binary numbers, we observe that these correspond to the 4 bytes of a multi-byte encoded character: In hexadecimal xf0 x9f x8d x88.
