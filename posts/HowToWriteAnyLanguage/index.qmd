...
How many bytes is enconded by the number of consecutive ones in the most significant digits of the first byte in a byte sequence: none means the encoded character fits in one byte.
...
In Rust I can use the crate `emojis` from the public registry. 
