...
R has the `emoji` package. After a short exploration of its [manual](https://emilhvitfeldt.r-universe.dev/emoji/doc/manual.html) it is possible to print the character boundaries of a sentence using the fruot emojis by theur chanracter boundaries.
