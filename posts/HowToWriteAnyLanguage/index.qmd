...
How many bytes is enconded by the number of consecutive ones in the most significant digits of the first byte in a byte sequence.
This means that there are no need for escape sequences to mark the presence of multiple characters in a long sequence, more on these below.
...
How to go from code point to glyph is beyond the scope of the standard.
