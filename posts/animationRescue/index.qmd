...
![Excerpt from page 48 of @Tufte:2001](thumbnail.jpg)
...
One of the examples used in Hadley Wickham's book on ggplot2 (@Wickham:2016) is about representing how two economic variables related to unemployment in the USA behave over time. The current computational resources available to us have made it relatively easy to address these visualization challenges to achieve visual excellence.
