...
So, what is the role of the offcial Github repo now? Before it was a way to get the source code for the exercises and the program itself. Read on for my analysis.

# Git and Github

Up to this point you are working on your machine and your solutions will be stored in the file system of your computer in the folder called `exercises`. You can check the official solutions in the corresponding file under the folder called `solutions`. But what if you wanted to store your solutions to the exercises in your account in Github? You may want to do this to keep a backup of your work in the cloud. Also to transfer your files between machines, like a desktop and a laptop. Whatever the reasons, avoid cloning or forking the official Rustlings repo. Simply start a new repo on the machine where you installed Rustlings, via cargo, and setup a remote repo on your GitHub account.

If, on the other side, you want and can contribute to the Rustlings project, then you need to follow the traditional GitHub fork, branch, and pull-request workflow. Usual contributions can be a new exercise to offer practice on a yet un-covered section of the book, or a legit bug fix to something that you have found not working correctly.
