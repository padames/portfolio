...
One last caveat, if you execute a command `cargo install rustlings` on the top folder of a cloned fork of the Rustlings repo, you will see a helpful error when doing the second step: `rustling init` for the first time. Have a look at the demo below.
...
If, on the other side, you want and can contribute to the Rustlings project, then you need to follow the traditional GitHub fork, branch, pull-request workflow. Usual contributions can be a new exercise to offer practice on a yet un-touched section of the book, or a genuine bug fix to something that you have found not working correctly.
